...
import (
	...
	chunkstorage "str/storage/internal/server"
...
type grpcServer struct {
	...
	storageService chunkstorage.Service
}
...
func (s *grpcServer) Get(req *proto.Get_Request, stream proto.StorageService_GetServer) error {
	...
	fileContent, err := s.storageService.Get(id, uint8(req.GetPart()))
	if err != nil {
		return err
	}

	// TODO
	for _, chunk := range fileContent {
